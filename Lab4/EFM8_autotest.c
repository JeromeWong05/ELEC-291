...
char _c51_external_startup (void)
{
	...
	TL1 = TH1;      // Init Timer1
	TMOD &= ~0xf0;  //0xF0 = 1111 0000, so when we & it with ~0xF0 => TMOD & 0000 1111 to clear the timer 1, which are the upper 4 bits
	TMOD |=  0x20;  //sets Timer 1 to Mode 2, 0x20 = 0010 0000, and we OR it so it only affects the upper 4 bits                  
	TR1 = 1; // START Timer1
